...
/* ═══════════════════════════════════════════════════════
   INTRO ANIMATION — 3D "Welcome to Quarq"
   ═══════════════════════════════════════════════════════ */
function Intro() {
  return (
    <div className="intro-screen">
      <div className="intro-container">
        <div className="intro-content">
          <h1 className="display-xl intro-title">
            <span className="intro-span">Welcome</span>
            <span className="intro-span">to</span>
            <span className="intro-span accent">Quarq</span>
          </h1>
...
export default function Home() {
  ...
  useEffect(() => {
    // Check if we've already shown intro in this session to avoid annoyance on refresh
    // (Optional, but usually better for UX. For now, we'll show it every time as requested)
    const timer = setTimeout(() => {
      setShowIntro(false)
    }, 2800) // 2s animation + buffer
  ...
  return (
    <div className="page-container">
      ...
      <div className={`landing-wrapper ${!showIntro ? 'visible' : ''}`}>
        <AuroraBackground />
        <ParticleCanvas />
